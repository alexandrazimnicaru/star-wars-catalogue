...
export const getPeopleWithCount = async (searchTerm = '', page = 1) => {
  try {
    ...
    return {
      people: results.map(person => parsePerson(person)) || [],
